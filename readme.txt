READ ME - meadorjc at gmail.com  03/23/2015 11:11am
...
execution policy to 
	RemoteSigned or AllSigned through the following commands. Adding a 
signature is recommended if you 
	plan to deploy this script to multiple computers and/or users.
...
a single, unrestricted 
	shell instance by running the following command.
